...
--output_dir='~/Videos/mpv-cut'
--output_file='~/Documents/time_pairs.txt'
output_file='~/.var/app/io.mpv.Mpv/config/mpv/scripts/time_pairs.txt'
...
c_concat_sh='~/.var/app/io.mpv.Mpv/config/mpv/scripts/c_concat.sh'
c_concat_sh2='~/.var/app/io.mpv.Mpv/config/mpv/scripts/c_concat2.sh'
run_dir='~/.var/app/io.mpv.Mpv/config/mpv/scripts/'
run_sh='~/.var/app/io.mpv.Mpv/config/mpv/scripts/run.sh'
